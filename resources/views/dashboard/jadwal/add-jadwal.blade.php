                            ...
                            <div class="row form-material">
                                ...
                                <div id="form_date_end" class="col-md-3" style="display: none">
                                    ...
                                    <div class="input-group">
                                        <input type="date"
                                            ...
                                            value="{{ old('tanggal_akhir') }}" min="<?= date('Y-m-d') ?>">
                                        @error('tanggal_akhir')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div id="form_jamPelajaran" class="col-md-3 mt-2">
                                    ...
                                    <input type="text" class="form-control @error('jp') is-invalid @enderror"
                                        placeholder="" id="jp" name="jp" value="{{ old('jp') }}"
                                        readonly="true">
                                    @error('jp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div id="form_biaya_penginapan" class="col-md-3 mt-2" style="display: none;">
                                    ...
                                    <input type="number"
                                        ...
                                        placeholder="Masukkan Biaya Penginapan Dinas" id="biaya_penginapan"
                                ...
                                <div id="form_biaya_transport" class="col-md-3 mt-2" style="display: none;">
                                    ...
                                    <input type="number"
                                        ...
                                        placeholder="Masukkan Biaya Transport Dinas" id="biaya_transport"
                                        name="biaya_transport" value="{{ old('biaya_transport') }}">
                                ...
                                <div id="form_biaya_representasi" class="col-md-3 mt-2" style="display: none;">
                                    ...
                                    <input type="number"
                                        ...
                                        placeholder="Masukkan Biaya Representasi Dinas" id="biaya_representasi"
                                        name="biaya_representasi" value="{{ old('biaya_representasi') }}">
                                    @error('biaya_representasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
    ...
    <script>
        $(document).ready(() => {
            ...
            document.getElementById('tipe_jadwal').addEventListener('change', function() {
                ...
                document.getElementById('form_biaya_harian').style.display = style_biaya;
            });
        })
    </script>
