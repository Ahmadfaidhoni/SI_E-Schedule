                ...
                <div class="card-body">
                    ...
                    <table class="table table-profile">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">Biaya Harian:</th>
                                <td>{{ isset($biaya) ? number_format($biaya->biaya_harian) : '-' }}</td>
                            </tr>
                            <tr>
                                <th scope="row">Biaya Penginapan:</th>
                                <td>{{ isset($biaya) ? number_format($biaya->biaya_penginapan) : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Biaya Transport:</th>
                                <td>{{ isset($biaya) ? number_format($biaya->biaya_transport) : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Biaya Representasi:</th>
                                <td>{{ isset($biaya) ? number_format($biaya->biaya_representasi) : '-' }}
                                </td>
                            </tr>
                            <tr>
